...
<div class="container-fluid welcome-container d-flex align-items-center justify-content-between">
   ...
   <body class="main-layout in_page">
    ...
    <div class="gallery">
        <div class="container">
        <h1><span class="green">Laboratorios</span></h1><br><br>
            <h2 class="text-center">Laboratorios Registrados</h2>
                ...
                <?php
                    ...
                    foreach ($laboratorios as $laboratorio) {
                        echo "<tr>
                                ...
                                <td>".$laboratorio["inventario"]."</td>
                                <td class='actions'>";

                        if ($_SESSION["rol"] == "administrador") {
                            echo "<a href='editarLaboratorio.php?id={$laboratorio['id']}' class='editar-link'>Editar</a>
                                <a href='mostrarLaboratorio.php?id={$laboratorio['id']}'>Eliminar</a>";
                        }
